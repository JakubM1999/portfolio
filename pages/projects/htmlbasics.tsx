...
import HTMLBasicsBanner from "../../images/InnerProjectImgs/htmlbasicsbanner.png";
            ...
            >
              ...
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/Accessibility"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/Accessibility/commit/8491bce7754de82e7e37ade880d4ac9cfa53d116"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
