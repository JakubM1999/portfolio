...
import EverbladeBanner from "../../images/InnerProjectImgs/everbaldebanner.png";
            ...
            >
              ...
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/EverBlade"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://www.figma.com/file/eJMcD4oQS07ijSwJ8VAK38/EverBlade?node-id=408%3A45"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/EverBlade/commit/8a8476d6f2c48d1a3a3355f4575f4e9010cbf825"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
