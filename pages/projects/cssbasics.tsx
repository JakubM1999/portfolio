...
import CSSBasicsBanner from "../../images/InnerProjectImgs/cssbasicsbanner.png";
            ...
            >
              ...
              >
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/Layouting"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
                ...
                <Box sx={{ display: "flex", flexDirection: "column", textAlign:'center'}}>
                  <a href={"https://github.com/JakubM1999/Layouting/commit/101ea85b9920ea8030cdc2181658e8dabfae5412"}>
                    <Button
                      sx={{
                        color: "black",
                        fontSize: "6.5vh",
